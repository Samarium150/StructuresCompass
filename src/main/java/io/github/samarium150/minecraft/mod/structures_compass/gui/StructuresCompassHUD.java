            ...
            if (stack.getItem() instanceof StructuresCompassItem) {
                ...
                if (pos == null || dim == null) {
                    RenderUtils.drawConfiguredStringOnHUD(
                        matrixStack, I18n.get(GeneralUtils.prefix + "hud_not_found"),
                        5, 5, 0xAA2116, relLineOffset
                    );
                } else {
                    RenderUtils.drawConfiguredStringOnHUD(
                        matrixStack, I18n.get(GeneralUtils.prefix + "hud_structure"),
                    ...
                    RenderUtils.drawConfiguredStringOnHUD(
                        matrixStack, I18n.get(GeneralUtils.prefix + "hud_dim"),
                        5, 5, 0xFFFFFF, ++relLineOffset
                    );
                    RenderUtils.drawConfiguredStringOnHUD(
                    ...
                    if (StructuresCompassConfig.HUD_Level.get() == 3) {
                        ...
                        temp = I18n.get(GeneralUtils.prefix + "hud_pos") + " [" + pos.getX() + temp + pos.getZ() + "]";
                        RenderUtils.drawConfiguredStringOnHUD(
                            matrixStack, temp,
                    ...
                    if (player.getCommandSenderWorld().dimension().location().toString().equals(dim)) {
                        ...
                        if ((StructuresCompassConfig.HUD_Level.get() == 3 && relLineOffset > 6) ||
                            ...
                            relLineOffset++;
                            RenderUtils.drawConfiguredStringOnHUD(
                                matrixStack, I18n.get(GeneralUtils.prefix + "hud_distance") + distance,
                        ...
                        relLineOffset++;
                        RenderUtils.drawConfiguredStringOnHUD(
                            matrixStack, I18n.get(GeneralUtils.prefix + "hud_wrong_dim"),
                            5, 5, 0xAA2116, ++relLineOffset
                        );
                    }
                }
