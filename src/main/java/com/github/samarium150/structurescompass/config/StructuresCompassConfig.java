...
public final class StructuresCompassConfig {
    ...
    public static final ForgeConfigSpec.EnumValue<com.github.samarium150.structurescompass.config.StructuresCompassConfig.Mode> filterMode;
    ...
    static {
        ...
        filterMode = builder
            ...
            .defineEnum("filterMode", com.github.samarium150.structurescompass.config.StructuresCompassConfig.Mode.blacklist);
